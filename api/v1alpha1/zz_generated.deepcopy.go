...
func (in *Overrides) DeepCopyInto(out *Overrides) {
	*out = *in
	...
	if in.PatchContainers != nil {
		in, out := &in.PatchContainers, &out.PatchContainers
		*out = make([]PatchContainer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PatchContainer) DeepCopyInto(out *PatchContainer) {
	*out = *in
	if in.Patch != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PatchContainer.
func (in *PatchContainer) DeepCopy() *PatchContainer {
	if in == nil {
		return nil
	}
	out := new(PatchContainer)
	in.DeepCopyInto(out)
	return out
}
